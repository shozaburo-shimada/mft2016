...
static unsigned int duty = PWM_RANGE / 2;
...
void calc_speed(){
    ...
    old = (unsigned long)(old_tv.tv_sec*1000000 +  old_tv.tv_usec);
    dur = new - old;
...
void gpio_setup(){
    ...
    //GPIO割り込みの登録
    wiringPiISR(2, INT_EDGE_RISING, calc_speed);
